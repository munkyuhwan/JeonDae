<nav class="main_nav">
    <ul>
        ...
        <li class="main_menu2"><a href="../main2" title="" <?= explode("/", $_SERVER['REQUEST_URI'])[1] == "main2"  ? "class=\"on\"":"" ?> ></a></li>
        <li class="main_menu3"><a href="../main3" title="거래" <?= explode("/", $_SERVER['REQUEST_URI'])[1] == "main3" || explode("/", $_SERVER['REQUEST_URI'])[1] == "sub_area" ? "class=\"on\"":"" ?> ></a></li>
