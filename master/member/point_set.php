...
<div id="wrap" class="skin_type01">
	...
	<div class="sub_wrap">
			...
			<a href="javascript:location.reload();" class="btn_refresh">새로고침</a>
				...
				<div class="write">
					...
					<div class="btn_wrap" style="margin-bottom:10px;">
						<b>회원관련 포인트지급 설정입니다. 회원가입, 로그인, 결제시 지급될 금액과 비중만 설정합니다.</b>
					</div>
		...
		<?} elseif($point_sect == "refund"){ // 포인트지급일 경우 시작 ?>
				...
				<tr>
					<th>우수회원 정보입력 지급포인트지급</th>
					<td>회원가입 후 추가정보를 입력하여 우수회원으로 승격된 회원에게 <input type="text" name="member_special_add" id="member_special_add" class="input_txt" style="width:100px;" value="<?= $point_row[member_special_add]?>"  required="yes" message="우수회원 정보입력 지급포인트지급" is_num="yes"/> 포인트지급 (지급하지 않을경우 0 입력)</td>
				</tr>-->				
				<tr>
					<th>회원 로그인시</th>
