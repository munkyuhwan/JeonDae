	...
	<div class="sub_wrap">
		...
		<div class="container clearfix">
			<div class="content">
				...
				<!-- 검색창 시작 -->
				<table class="search">
				<form name="s_mem" id="s_mem" method="post" action="member_point_list.php">
			...
			for ($i=0; $i<mysqli_num_rows($result); $i++){
				...
				<input type="hidden" name="mile_pre" value="<?=$current_point?>"/>
					...
					<tr>
						...
						<td>
							<input type="text" style="width:90%;" name="mile_title" required="yes" message="<?=$point_str?> 수정사유" value="">
						</td>
