...
$where = " and c.section = '".$_SITE_TITLE_G_SECTION."' ";
...
$query = "select a.level_name,b.* from member_level_set a INNER JOIN member_info b ON a.level_code = b.user_level INNER JOIN member_coupon c ON b.idx = c.member_idx where 1=1 ".$where.$order_by." limit ".$StarRowNum." , ".$EndRowNum;
//echo "<br><br>쿼리 = ".$query."<br><Br>";

$result = mysqli_query($gconnet,$query);

$query_cnt = "select b.idx from member_level_set a INNER JOIN member_info b ON a.level_code = b.user_level INNER JOIN member_coupon c ON b.idx = c.member_idx where 1=1 ".$where;
						...
						<tr>
							...
							<td colspan="5">
								<select name="field" size="1" style="vertical-align:middle;width:20%;">
									...
									<option value="b.user_id" <?=$field=="b.user_id"?"selected":""?>>아이디</option>
									<option value="b.user_name" <?=$field=="b.user_name"?"selected":""?>>성명</option>
								</select>
