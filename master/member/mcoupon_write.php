		...
		<table class="t_view">
				<colgroup>
				  ...
				  <tr id="coupon_text1" style="display:none;">
						<th >쿠폰 유효기간</th>
						<td width="*" colspan="3">가입일로부터 <input type="text" style="width:70px;" name="expire_date_auto" required="no" message="쿠폰 유효기간" is_num="yes"> 일 간 &nbsp;<font style="color:red;">회원가입 자동발행 쿠폰의 경우 입력하세요.</font></td>
				  </tr>
				  <!--<tr id="coupon_text2" style="display:none;">-->
				  <tr id="coupon_text2">
						<th >쿠폰 만료일</th>
						<td width="*" colspan="3"><input type="text" style="width:150px;" onClick="new CalendarFrame.Calendar(this)" name="expire_date" required="no" message="쿠폰 만료일" readonly>&nbsp;<font style="color:red;"><!--회원조회 일반발행 쿠폰의 경우 입력하세요.--></font></td>
				  </tr>
				
					<tr>
						<th >쿠폰 간략설명</th>
						<td width="*" colspan="3"><input type="text" style="width:80%;" name="coupon_title" required="yes"  message="쿠폰 간략설명" value=""></td>
					</tr>
					<tr>
						<th >할인종류</th>
					...
					<tr id="coupon_dis_txt1" style="display:none;">
						<th >쿠폰 액면가</th>
						<td width="*" colspan="3">결제금액에서 <input type="text" style="width:20%;" name="coupon_price" required="no"  message="쿠폰 액면가" is_num="yes" value=""> 원 할인.</td>
					</tr>
					<tr id="coupon_dis_txt2" style="display:none;">
						<th >쿠폰 할인율</th>
						<td width="*" colspan="3">결제금액에서 <input type="text" style="width:20%;" name="coupon_per" required="no"  message="쿠폰 할인율" is_num="yes" value=""> % 할인</td>
					</tr>
