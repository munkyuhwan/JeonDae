...
<?
	...
	/*if($user_nick){ // 닉네임을 입력했을때 
		...
		$sql_pre4 = "select idx from member_info where user_nick = '".$user_nick."' ";
	...
	parent.location.href =  "member_view.php?idx=<?=$member_idx?>&bmenu=1&smenu=1&v_sect=GEN&s_gubun=NOR";
	//-->
	</SCRIPT>
	<?}else{?>
	<SCRIPT LANGUAGE="JavaScript">
