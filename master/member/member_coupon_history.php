...
$coupon_sql = "update member_coupon set coupon_sect = 'C' where member_idx = '".$mem_idx."' and section = '".$_SESSION['admin_yonex_section']."' and expire_date < '".$bis_sdate."' and coupon_sect = 'A' ";
$coupon_result = mysqli_query($gconnet,$coupon_sql);

############### 만료기간이 지난 쿠폰은 기간만료로 처리한다 종료 ######################

$sql_sub1 = "select user_id,user_name,user_level,gender FROM member_info where 1=1 and idx='".$mem_idx."' ";
//echo $sql_sub1;
...
$where .= " and member_idx='".$mem_idx."' and section = '".$_SESSION['admin_yonex_section']."' ";
...
$query = "select * from member_coupon where 1=1 ".$where.$order_by." limit ".$StarRowNum." , ".$EndRowNum;

//echo "<br><br>쿼리 = ".$query."<br><Br>";

$result = mysqli_query($gconnet,$query);

$query_cnt = "select idx from member_coupon where 1=1 ".$where;
