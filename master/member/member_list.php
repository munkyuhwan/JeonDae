...
$query = "select *,(select user_name from member_info where 1 and member_type='GEN' and user_id=a.chuchun_id) as recom_name from member_info a where 1 ".$where.$order_by." limit ".$StarRowNum." , ".$EndRowNum;
	...
	<div class="sub_wrap">
		...
		<div class="container clearfix">
			<div class="content">
				...
				<?if($s_gubun == "NOR"){?>
					<button class="btn_add" onclick="go_regist();"><span>회원등록</span></button>
				<?}?>
				</div>
				<!-- 네비게이션 종료 -->
				<div class="list">
				...
				<form name="s_mem" id="s_mem" method="post" action="member_list.php">
						...
						<tr>
							...
							<td colspan="2">
								<select name="s_level" size="1" style="vertical-align:middle;" >
									...
									<option value="Y" <?=$s_level=="Y"?"selected":""?>>승인</option>
									<option value="N" <?=$s_level=="N"?"selected":""?>>미승인</option>
								</select>
							</td>
							<th scope="row">국적</th>
							<td colspan="2">
								<select name="s_level" size="1" required="yes"  message="국적" style="vertical-align:middle;" >
							...
							<td colspan="2">
								<select name="s_sect1" size="1" style="vertical-align:middle;width:200px;" >
									<option value="">선택하세요</option>
						...
						<!--<tr>
							...
							?>
								<option value="<?=$sub_row[idx]?>" <?=$s_sect2==$sub_row[idx]?"selected":""?>><?=$sub_row[com_name]?></option>
							<?}?>	
								</select>
							</td>
						...
						<table class="search_list">
							...
							<thead>
								<tr>
									...
									<th scope="col">연락처</th>
									<th scope="col">이메일</th>
									<!--<th scope="col">스카이프 ID</th>-->
									<th scope="col">생년월일</th>
									<?if($s_gubun == "SPE"){?>
										<th scope="col">VVIP 가입기간</th>
										<th scope="col">VVIP 종료일</th>
									<?}?>
